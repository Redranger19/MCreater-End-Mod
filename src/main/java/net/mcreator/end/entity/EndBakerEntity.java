...
package net.mcreator.end.entity;
...
public class EndBakerEntity extends EndModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.95f)).build("end_baker").setRegistryName("end_baker");

	public EndBakerEntity(EndModElements instance) {
		super(instance, 4);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EndBakerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -103, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("end_baker_spawn_egg"));
	}
	...
	public static class CustomEntity extends VillagerEntity {
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.yes")), 0.15f,
					1);
		}
